      ...
      <div className="max-w-md w-full">
        <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Bienvenido a PixelHub</h1>
            <p className="text-gray-600">Inicia sesión para gestionar tus suscripciones</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-700 font-medium mb-2">Cuentas demo:</p>
            <div className="text-xs text-blue-600 space-y-1">
              <div>admin@pixelhub.com / admin123</div>
              <div>demo@pixelhub.com / demo123</div>
            </div>
          </div>
        </div>
      </div>
